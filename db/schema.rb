...
ActiveRecord::Schema.define(version: 20_161_110_024_829) do
  ...
  create_table 'issue_respond_votes', force: :cascade do |t|
    ...
    t.datetime 'created_at',       null: false
    t.datetime 'updated_at',       null: false
    t.index %w(issue_respond_id user_id), name: 'index_issue_respond_votes_on_issue_respond_id_and_user_id', unique: true
  end
  ...
  create_table 'keywords', force: :cascade do |t|
    ...
    t.datetime 'created_at',       null: false
    t.datetime 'updated_at',       null: false
    t.index %w(keywordable_type keywordable_id), name: 'index_keywords_on_keywordable_type_and_keywordable_id'
  end
